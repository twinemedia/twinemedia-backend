...
object App {
	 ...
	 * This method should only be called on application startup.
	 * @param vertx The Vert.x instance to use
	 * @param config The application configuration to use
	 * @since 2.0.0
	 */
	suspend fun initServices(vertx: Vertx, config: AppConfig) {
	...
	private fun start(config: AppConfig) {
		...
		GlobalScope.launch(vertx.dispatcher()) {
			...
			vertx.deployVerticle(
				ApiVerticle::class.java, deploymentOptionsOf(
