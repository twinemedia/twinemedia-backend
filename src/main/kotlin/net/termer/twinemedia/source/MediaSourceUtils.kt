 ...
 * Illegal characters and sequences are as follow:
 * \r (carriage return), \n (newline), --, .., #, %, &, {, }, \, <, >, *, ?, $, !, ', ", :, @, +, `, |, =
...
/**
 * Wraps a Throwable as a MediaSourceException and returns it
 * @param e The Throwable to wrap
 * @return The wrapped throwable
 * @since 1.5.0
 */
fun wrapThrowableAsMediaSourceException(e: Throwable) = if(e is MediaSourceException) e else MediaSourceException("${e.javaClass.name}: ${e.message}")